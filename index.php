...
<head>
    ...
    <title>Песня на заказ для близких — 2000 ₽ и готово за 1–3 дня</title>
    <meta name="description" content="Пишу персональные песни на заказ для юбилеев, годовщин, признаний и семейных праздников. Фиксированная цена 2000 ₽, первые демо в течение 1–3 дней." />
    ...
    <meta property="og:title" content="Песня на заказ за 2000 ₽ — подарок близким" />
    ...
    <meta name="twitter:title" content="Песня на заказ за 2000 ₽" />
...
<section class="hero">
    <div class="hero__content container">
        <div class="hero__text">
            ...
            <p>Расскажите мне о человеке, ради которого готовите праздник. Я напишу текст, подберу музыку и голос, чтобы за 1–3 дня вы получили готовый трек за 2000 ₽. Юбилей родителей, годовщина отношений или признание другу — песня сохранит ваши чувства навсегда.</p>
            <div class="hero__cta">
                ...
                <ul class="hero__badges" aria-label="Преимущества сервиса">
                    ...
                    <li class="badge">💸 Фиксированная цена 2000 ₽</li>
    ...
    <section class="section" id="offer">
        <div class="container offer">
            <div class="offer__content">
                ...
                <p class="section__lead">Фиксированная стоимость 2000 ₽ включает текст, музыку, вокал и финальный мастер. Никаких скрытых платежей — рассказываете историю, а я делаю остальное.</p>
            ...
            <div class="request">
                <div class="request__intro">
                    ...
                    <ul class="request__list">
                        ...
                        <li>Стоимость фиксирована — 2000 ₽, оплата после подтверждения концепции.</li>
